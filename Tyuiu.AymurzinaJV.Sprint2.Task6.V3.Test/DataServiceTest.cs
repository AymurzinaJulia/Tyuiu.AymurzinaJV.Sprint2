using Tyuiu.AymurzinaJV.Sprint2.Task6.V3.Lib;
namespace Tyuiu.AymurzinaJV.Sprint2.Task6.V3.Test
{
    [TestClass]
    public sealed class DataServiceTest
    {
        ...
        public void TestMethod1()
        {
            ...
            Assert.AreEqual("Неверный порядковый номер дня недели.", ds.FindDayName(10));
